This project is essentially to create an SVM model that attempts to predict if someone had previously reported a heart attack based on their demographics and lifestyle choices.
